...
async function main() {
    ...
    server.tool("knows_evidence_summary", {
    ...
    server.tool("knows_evidence_highlight", {
        evidence_id: z.string().min(1),
    }, async (args) => {
    ...
    server.tool("knows_get_paper_en", {
        evidence_id: z.string().min(1),
    ...
    server.tool("knows_get_paper_cn", {
        evidence_id: z.string().min(1),
    }, async (args) => {
    ...
    server.tool("knows_auto_tagging", {
    ...
    server.tool("knows_list_question", {
    ...
    server.tool("knows_list_interpretation", {
        from_time: z.number().optional(),
        to_time: z.number().optional(),
        page: z.number().optional(),
        page_size: z.number().optional(),
